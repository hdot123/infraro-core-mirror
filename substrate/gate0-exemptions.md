...
| `evidence/` | exemption | hdot123 | evidence archive | verbatim archival material, no scanning needed |
...
|---|---|---|---|---|
| `CODE_HYGIENE_DUPLICATE_BLOCK` #9 | find_existing_summary_comment duplicate | hdot123 | eng-issue-triage | `actions/droid-review-aggregate/publish_findings.py::L156 <-> src/infra_core/engine/droid_review/publish_findings.py::L156` - duplicate between actions and engine versions (intentional, separate deployment cycles) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #10 | _parse_paginated_json duplicate | hdot123 | eng-issue-triage | `actions/droid-review-aggregate/publish_findings.py::L133 <-> src/infra_core/engine/droid_review/publish_findings.py::L133` - duplicate between actions and engine versions (intentional, separate deployment cycles) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #16 | find_existing_inline_comments duplicate | hdot123 | eng-issue-triage | `actions/droid-review-aggregate/publish_findings.py::L194 <-> src/infra_core/engine/droid_review/publish_findings.py::L194` - duplicate between actions and engine versions (intentional, separate deployment cycles) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #20 | test helper function duplicate | hdot123 | eng-issue-triage | `tests/test_sweep_pipeline_fix.py::L117 <-> tests/test_real_shell_adversarial_matrix.py::L113` - `_run_extracted_guard` function duplicated across test modules (acceptable, test-specific) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #22 | test helper function duplicate | hdot123 | eng-issue-triage | `tests/test_sweep_pipeline_fix.py::L39 <-> tests/test_real_shell_adversarial_matrix.py::L35` - `_extract_pipeline` function duplicated across test modules (acceptable, test-specific) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #23 | test helper function duplicate | hdot123 | eng-issue-triage | `tests/test_sweep_pipeline_fix.py::L57 <-> tests/test_real_shell_adversarial_matrix.py::L53` - `_extract_case_guard` function duplicated across test modules (acceptable, test-specific) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #24 | test helper function duplicate | hdot123 | eng-issue-triage | `tests/test_sweep_pipeline_fix.py::L74 <-> tests/test_real_shell_adversarial_matrix.py::L70` - `_run_extracted_guard` function duplicated across test modules (acceptable, test-specific) |
| `CODE_HYGIENE_DUPLICATE_BLOCK` #25 | 88% similarity false positive | hdot123 | eng-issue-triage | `tests/test_trigger_release_contract.py::L35 <-> tests/test_trigger_ci_droid_routing.py::L28` - `_make_env` function with 88% similarity (acceptable, similar but distinct test patterns) |
