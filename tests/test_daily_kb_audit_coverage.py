...
class TestTcpConnectOk:
    ...
    @patch("infra_core.packs.memory.daily_audit.socket.create_connection")
...
class TestCheckSshReachable:
    @patch("infra_core.packs.memory.daily_audit._run_ssh")
...
class TestCheckServer:
    @patch("infra_core.packs.memory.daily_audit._tcp_connect_ok")
    @patch("infra_core.packs.memory.daily_audit.check_ssh_reachable")
...
class TestCheckInfrastructure:
    def test_returns_empty_when_no_inventory(self, tmp_path: Path):
        with patch(
            "infra_core.packs.memory.daily_audit._load_infra_inventory",
            return_value=None,
        ):
    ...
    @patch("infra_core.packs.memory.daily_audit.check_database")
    @patch("infra_core.packs.memory.daily_audit.check_server")
    @patch("infra_core.packs.memory.daily_audit._load_infra_inventory")
...
class TestMain:
    @patch("infra_core.packs.memory.daily_audit.check_infrastructure")
    @patch("infra_core.packs.memory.daily_audit.load_registered_projects")
    @patch("infra_core.packs.memory.daily_audit.write_report")
    ...
    @patch("infra_core.packs.memory.daily_audit.build_global_kb_fingerprints")
    @patch("infra_core.packs.memory.daily_audit.audit_project")
    @patch("infra_core.packs.memory.daily_audit.check_infrastructure")
    @patch("infra_core.packs.memory.daily_audit.load_registered_projects")
    @patch("infra_core.packs.memory.daily_audit.write_report")
    ...
    @patch("infra_core.packs.memory.daily_audit.notify_via_lark")
    @patch("infra_core.packs.memory.daily_audit.build_global_kb_fingerprints")
    @patch("infra_core.packs.memory.daily_audit.audit_project")
    @patch("infra_core.packs.memory.daily_audit.check_infrastructure")
    @patch("infra_core.packs.memory.daily_audit.load_registered_projects")
