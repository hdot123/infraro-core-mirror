...
def test_suppress_json_covers_inherent_layout_findings():
    ...
    # L133/156/194 是 publish_findings 的辅助函数（_parse_paginated_json / find_existing_summary_comment / find_existing_inline_comments）
    # test file pairs 使用 helper functions（包括 class methods test_extracted_guard_adversarial_matrix）因此有 4 组
    # （L39/L35, L57/L53, L74/L70, L117/L113）
    dup_block_pairs = {
        ...
        # publish_findings L133/156/194 辅助函数（scrutiny 修复，2026-09-20）
        "actions/droid-review-aggregate/publish_findings.py::L133 <-> src/infra_core/engine/droid_re.401854e9",
        "src/infra_core/engine/droid_review/publish_findings.py::L133 <-> actions/droid-review-aggre.b10a5398",
        "actions/droid-review-aggregate/publish_findings.py::L156 <-> src/infra_core/engine/droid_re.ec190b72",
        "src/infra_core/engine/droid_review/publish_findings.py::L156 <-> actions/droid-review-aggre.ce6ede58",
        "actions/droid-review-aggregate/publish_findings.py::L194 <-> src/infra_core/engine/droid_re.7892f814",
        "src/infra_core/engine/droid_review/publish_findings.py::L194 <-> actions/droid-review-aggre.7f803f41",
        # test file pairs（同源复刻对，helper functions）
        "tests/test_sweep_pipeline_fix.py::L39 <-> tests/test_real_shell_adversarial_matrix.py::L35",
        "tests/test_real_shell_adversarial_matrix.py::L35 <-> tests/test_sweep_pipeline_fix.py::L39",
        "tests/test_sweep_pipeline_fix.py::L57 <-> tests/test_real_shell_adversarial_matrix.py::L53",
        "tests/test_real_shell_adversarial_matrix.py::L53 <-> tests/test_sweep_pipeline_fix.py::L57",
        "tests/test_sweep_pipeline_fix.py::L74 <-> tests/test_real_shell_adversarial_matrix.py::L70",
        "tests/test_real_shell_adversarial_matrix.py::L70 <-> tests/test_sweep_pipeline_fix.py::L74",
        # test_extracted_guard_adversarial_matrix class method（scrutiny round-3 修复，2026-09-20）
        "tests/test_sweep_pipeline_fix.py::L117 <-> tests/test_real_shell_adversarial_matrix.py::L113",
        "tests/test_real_shell_adversarial_matrix.py::L113 <-> tests/test_sweep_pipeline_fix.py::L117",
        "tests/test_trigger_release_contract.py::L35 <-> tests/test_trigger_ci_droid_routing.py::L28",
        "tests/test_trigger_ci_droid_routing.py::L28 <-> tests/test_trigger_release_contract.py::L35",
    }
